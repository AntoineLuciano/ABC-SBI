...
def plot_metric_for_a_dataset(metric_name, ALPHAS, METRICS_ABC, METRICS_NRE, METRICS_CORRECTED_NRE,N_SAMPLES, PATH_NAME = "", show = True):
    ...
    plot_metric(ALPHAS, abc, nre, corrected_nre, PATH_NAME, show = show, metric_name = metric_name)
    

def plot_metric_for_many_datasets(metric_name, ALPHAS, METRICS_ABC, METRICS_NRE, METRICS_CORRECTED_NRE, N_SAMPLES, N_DATASETS, PATH_NAME = "", show = True):
